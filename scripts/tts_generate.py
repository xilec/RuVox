...
def synthesize(model, text: str, speaker: str = DEFAULT_SPEAKER,
               sample_rate: int = DEFAULT_SAMPLE_RATE) -> tuple:
...
def synthesize_long_text(model, text: str, speaker: str = DEFAULT_SPEAKER,
...
Available speakers: aidar, baya, kseniya, xenia (default), eugene
    ...
    parser.add_argument('--speaker', '-s', default=DEFAULT_SPEAKER,
                        choices=SPEAKERS, help=f'Speaker voice (default: {DEFAULT_SPEAKER})')
