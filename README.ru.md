...
- **Без Nix:** вручную установить Rust stable + Node 20 + Python 3.12 + system-deps Tauri 2 (webkitgtk 4.1, libsoup 3, gtk3, libmpv, libopus, pipewire/pulseaudio) — см. `buildInputs` в `shell.nix`.
