    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                "Используем риэкт для фронтенда.",
            ),
            # Multiple terms
            (
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                ["эйч ти ти пи эс", "docs", "пайтон", "орг"],
            ),
            (
                "Репозиторий на https://github.com/user/repo",
                ["эйч ти ти пи эс", "гитхаб", "user", "repo"],
            ),
            (
                "API доступен на http://localhost:8080/api",
                ["эйч ти ти пи", "localhost", "восемь тысяч восемьдесят", "api"],
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                ["admin", "собака", "экзампл", "ком"],
            ),
            (
                "Контакт: support@company.ru",
                ["support", "собака", "company", "ру"],
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                ["нода", "js", "восемнадцать", "точка", "ноль"],
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                ["слэш", "home", "user", "config", "ямл"],
            ),
            (
                "Открой ~/Documents/report.pdf",
                ["тильда", "Documents", "report", "pdf"],
            ),
        ],
    )
