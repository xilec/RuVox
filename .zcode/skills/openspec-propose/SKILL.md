...
description: Propose a new OpenSpec change with all artifacts (proposal, design, specs, tasks) generated in one step, ready for implementation.
when_to_use: Use when the user wants to quickly describe what they want to build and get a complete proposal with design, specs, and tasks ready for implementation.
---
