...
description: >-
  ...
  generator runs.
whenToUse: Pre-PR review of a branch diff, or any code review request.
tools:
  - Read
  - Grep
  - Glob
...
Your final message is the entire handoff: make it the complete, self-contained review report for the caller.
