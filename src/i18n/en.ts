...
export const en: Record<MessageKey, string> = {
  ...
  'errors.export.dialog_failed': 'Failed to open the save dialog: {0}',
  ...
  'settings.dictionary.entries_count': 'Entries: {0}',
  'dictionary.title': 'Pronunciation dictionary',
  'dictionary.search.placeholder': 'Search words',
  'dictionary.add': 'Add a word',
  'dictionary.edit': 'Edit',
  'dictionary.badge.overrides': 'overrides built-in',
  'dictionary.empty': 'The dictionary is empty. Add a word or import a file.',
  'dictionary.no_results': 'Nothing found',
  'dictionary.column.from': 'Word',
  'dictionary.column.to': 'Spoken form',
  'dictionary.form.from': 'Word',
  'dictionary.form.from.placeholder': 'e.g. IPv6 or GitHub',
  'dictionary.form.to': 'How to pronounce',
  'dictionary.form.to.placeholder': 'e.g. айпи ви шесть',
  'dictionary.form.error.from.required': 'Enter a word: Latin letters and digits, at least one letter.',
  'dictionary.form.error.from.charset': 'Latin letters and digits only, at least one letter (e.g. IPv6, x86).',
  'dictionary.form.error.from.too_long': 'The word is too long (64 characters max).',
  'dictionary.form.error.to.required': 'Enter the spoken form.',
  'dictionary.form.error.to.too_long': 'The spoken form is too long (256 characters max).',
  'dictionary.form.warning.latin':
    'The spoken form contains Latin letters or digits — they will be read as-is.',
  'dictionary.status.saved': 'All changes saved',
  'dictionary.status.saving': 'Saving…',
  'dictionary.status.error': 'Not saved — retry',
  'dictionary.delete.title': 'Delete word',
  'dictionary.delete.message': 'Remove “{0}” from the dictionary?',
  'dictionary.import': 'Import…',
  'dictionary.export': 'Export…',
  'dictionary.drop.hint': 'Drop a dictionary file here (.toml)',
  'dictionary.import.choose.title': 'Import dictionary',
  'dictionary.import.choose.message': 'File: {0}',
  'dictionary.import.merge': 'Merge',
  'dictionary.import.merge.hint': 'File entries are added to the current ones; on collisions the file wins',
  'dictionary.import.replace': 'Replace the list',
  'dictionary.import.replace.hint': 'The current list is fully replaced by the file contents',
  'dictionary.import.done.title': 'Dictionary imported',
  'dictionary.import.done.message': 'Added: {0}, updated: {1}, skipped: {2}',
  'dictionary.import.failed.title': 'Failed to import the dictionary',
  'dictionary.export.done.title': 'Dictionary exported',
  'dictionary.export.failed.title': 'Failed to export the dictionary',
  'dictionary.save.failed.title': 'Failed to save the dictionary',
  'dictionary.quickadd.button': 'To dictionary',
  'dictionary.quickadd.hint': 'Select a single Latin word',
};
